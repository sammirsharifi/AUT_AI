...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    return search(problem,util.PriorityQueue(),True,heuristic)

def iterative_deepening_depthFirstSearch(problem,level=100):
